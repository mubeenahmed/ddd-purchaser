...
class SlickShippmentAddress(tag: Tag) extends Table[(Int, Int, String, String, String, String)](tag, "shippment_address")
{
  ...
  def * = (id, orderId, address1, address2, postalCode, city)
}
